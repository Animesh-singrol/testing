  ...
  return (
    ...
    >
      <main className=" flex flex-1 flex-col items-center justify-center p-6 h-full mt-24 ">
        {/* Main Heading */}
        <h1 className="text-5xl font-bold mb-5 md:mb-12 text-[var(--text-color)]">
          Patient Record
        </h1>
        ...
        <div className="flex-col gap-7 flex justify-center md:gap-28 md:flex-row w-full">
          ...
          >
            <div className="w-40 h-40 md:w-48 md:h-48  bg-[var(--background-color)] hover:bg-[var(--hover-background-color)] border border-[var(--grey-border)] rounded-xl flex items-center justify-center shadow-lg">
              {/* <Image
                src={addPatientImg}
                alt="Add New Patient"
                className="w-20 h-20 object-contain"
              /> */}
              <FaPlus size={100} color="var(--text-color)" />
            </div>
            <p className="mt-4 text-[var(--text-color)] text-center font-semibold text-2xl">
              Add New Patient
            </p>
          </div>
          <div
